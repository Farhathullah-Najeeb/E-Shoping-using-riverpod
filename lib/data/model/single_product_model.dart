...
class GetSingleProductModel {
  ...
  GetSingleProductModel copyWith({
    int? id,
    String? title,
    double? price,
    String? description,
  ...
  factory GetSingleProductModel.fromMap(Map<String, dynamic> map) {
    return GetSingleProductModel(
  ...
  factory GetSingleProductModel.fromJson(String source) => GetSingleProductModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'GetSingleProductModel(id: $id, title: $title, price: $price, description: $description, category: $category, image: $image, rating: $rating)';
  }

  @override
  bool operator ==(covariant GetSingleProductModel other) {
